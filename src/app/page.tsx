      ...
      <section id="links" className="text-xl">
        ...
        >
          <div className="tracking-tight">
            ...
            <br/>
            check my work history in my <a className="text-blue-600 dark:text-blue-400" href="https://www.cake.me/s--lYaiUqJPPCVsX5T_PXGRuQ--/raymel" target="_blank">cv / resume</a>.
            <br/>
            <br/>
